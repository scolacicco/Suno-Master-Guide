# **Suno AI Style Tag Sheet**

This document provides an extensive, though not exhaustive, list of style tags that can be used in the "Style of Music" box in Suno AI.

## **Table of Contents**

* [Introduction](#bookmark=id.xm73laz9klb)  
* [Style Tag List (Alphabetical Grouping)](#bookmark=id.gzky2jypk4dc)  
  * [\# (Numbers)](#bookmark=id.by8ib0xi9wg8)  
  * [A](#bookmark=id.ce6iarwpnvsj)  
  * [B](#bookmark=id.fgzsqtiufoib)  
  * [C](#bookmark=id.zc765trlq4jd)  
  * [D](#bookmark=id.71ayg6ekqjq)  
  * [E](#bookmark=id.np53suvgxcuu)  
  * [F](#bookmark=id.u4kyz7xuze5i)  
  * [G](#bookmark=id.ndojqwik8sor)  
  * [H](#bookmark=id.lt3zg7j87gbe)  
  * [I](#bookmark=id.plqghwx3lkxf)  
  * [J](#bookmark=id.hhnnl5isiphy)  
  * [K](#bookmark=id.totmexsnp44q)  
  * [L](#bookmark=id.e2p17tmwlrbz)  
  * [M](#bookmark=id.pkq81jktq4lx)  
  * [N](#bookmark=id.5f0wwlrsina)  
  * [O](#bookmark=id.a9ma6mo42zil)  
  * [P](#bookmark=id.ldllhn42fw3l)  
  * [Q](#bookmark=id.9ov8nechduie)  
  * [R](#bookmark=id.h5zf5y79c039)  
  * [S](#bookmark=id.baqqh0vrdqx0)  
  * [T](#bookmark=id.v5w5d1c1f0v3)  
  * [U](#bookmark=id.7bel4lwptzrb)  
  * [V](#bookmark=id.pzan85u1g34m)  
  * [W](#bookmark=id.9dpaorr8nwz7)  
  * [X](#bookmark=id.dul9e5ljvjzd)  
  * [Y](#bookmark=id.nd9z9a2xmvo7)  
  * [Z](#bookmark=id.43ue923zl7kr)

## **Introduction**

* **Flexibility:** Suno is intelligent; any style descriptor, even those not listed here, can potentially be interpreted. Feel free to invent your own or combine styles creatively.  
* **Specificity:** Bonus points for using styles that are obscure, highly specific, historically accurate, or even conceptually paradoxical (like 16-bit roots reggae).  
* **LLM Focus:** Styles that reference digital concepts, AI, or language processing might yield interesting results.  
* **Combination:** The real power comes from combining these tags (e.g., acoustic chicago blues algorave, ambient trance folk, punk polka).

## **Style Tag List (Alphabetical Grouping)**

*(This list is derived from the provided document and formatted for readability. Use Ctrl+F or Cmd+F to search.)*
...
* chanson funk  
* chanson soul  
* chicago blues (see acoustic chicago blues)  
* chillstep  
* chillstep chillwave  
* chillsynth  
* chillsynth mento  
...
* dark reggaeton  
* dark salsa  
* delta blues (see accordion delta blues, mandarin delta blues)  
* delta blues house  
* dembow  
...
* electropop  
* electropop grunge  
* emo (see polka emo, sertanejo emo)
...
* flamenco  
* flamenco hip hop  
* folk (see african folk, afrikaner folk, american primitivism, anti-folk, appalachian folk, blues folk, chanson, classical folk, soulful folk)  
...
* funk  
* funk bedroom pop  
* future bass (see jazz future bass, kawaii future bass)  
* future chillwave  
* future egyptian
...
* mento (see chillsynth mento, ambient techno mento)  
* merengue  
* metal  
* metal grunge  
* motown
...
* opera (see calypso opera, korean opera, saxophone opera)
...
* *(None listed, but consider 'Quantum' prefixes for advanced styles)*
...
* symphonic algorave  
* symphonic bluegrass  
* symphonic metal (see bubblegum bass symphonic metal, city pop symphonic metal, harpischord symphonic metal, house symphonic metal)  
* synthpop  
* synthpop coptic  
* synthpop hawaiian  
* synthwave  
...
* tango boogie  
* techno  
* texas blues (see acoustic texas blues)  
* trance  
* trap  
* trap g-funk  
* trap k-pop  
...
* *(None listed, consider 'Wave' suffixes like 'synthwave', 'chillwave')*
